...
Respecto a los modelos, notamos una mayor fiabiliad en CLARA que si que lo hemos podido ejecutar con varias muestras y el resultado siempre ha sido muy similar. PAM probablemente necesite un entrenamiento más adecuado, con un mejor dataset y si que hemos visto que con 3 clústeres ha llegado a clasificar mejor que con 4 o 5. 
...
- En cuanto a los modelos, lograr una mejor explicatividad de CLARA.

- También iniciamos un análisis PCA para aplicar a KMeans que habría que concluir.
